    ...
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div className="min-w-0">
          <h1 className="text-xl sm:text-2xl font-bold">거래 내역</h1>
      ...
      <div className="p-3 sm:p-6 rounded-2xl bg-card border border-border">
            ...
            {transactions.map((t, i) => {
              ...
              return (
                <motion.div
                  ...
                  className="flex items-center justify-between gap-3 sm:gap-4 p-3 sm:p-4 rounded-xl hover:bg-muted/50 transition-colors cursor-pointer border border-transparent hover:border-border"
                >
                  <div className="flex items-center gap-2 sm:gap-4 min-w-0">
                    <div
                      className={`w-10 sm:w-12 h-10 sm:h-12 rounded-full flex-shrink-0 flex items-center justify-center ${colorClass}`}
                    >
                      <Icon size={20} />
                    </div>
                    <div className="min-w-0">
